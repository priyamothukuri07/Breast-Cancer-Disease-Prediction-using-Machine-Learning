...
# ---------------- PDF GENERATOR ---------------- #
def create_pdf(name, age, gender, prediction, probability):
...
with col2:
    ...
    if st.button("Predict Cancer Risk") and name.strip() != "":
...
""")
        ...
        # Download PDF
        pdf_path = create_pdf(name, age, gender, prediction, probability)
